...
public class test_job implements TalendJob {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_GIT_test_job = new byte[0];
		static byte[] commonByteArray_GIT_test_job = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_GIT_test_job.length) {
					if (length < 1024 && commonByteArray_GIT_test_job.length == 0) {
						commonByteArray_GIT_test_job = new byte[1024];
					} else {
						commonByteArray_GIT_test_job = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_GIT_test_job, 0, length);
				strReturn = new String(commonByteArray_GIT_test_job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_GIT_test_job, 0, length);
				strReturn = new String(commonByteArray_GIT_test_job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_GIT_test_job) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = test_job.class.getClassLoader()
					.getResourceAsStream("git/test_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 39207 characters generated by Talaxie Open Studio for Data Integration on the
 * 2 octobre 2024 à 14:46:02 GST
 ************************************************************************************************/